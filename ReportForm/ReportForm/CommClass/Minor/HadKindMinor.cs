...
{
    public class HadKindMinor :ReportForm.CommClass.Father.MTable
    {
        #region ==== 建構元 ====
        public HadKindMinor()
        {
        ...
        public HadKindMinor(System.Collections.Generic.List<int> percentList)
        {
            this.perList = percentList;          
        }

        public HadKindMinor(int width, int height, int titleCnt, int nonShow, int reportColCnt, System.Collections.Generic.List<int> percentList)
        {
            Width = width;
            Height = height;
            TitleCnt = titleCnt;
