...
{
    public   interface I_MFCC_CMS : RemoteInterface.MFCC.I_MFCC_Base
    {
        ...
        void SendDisplay(string devName,int dataType, int icon_id, int g_code_id, int hor_space, string mesg, byte[] colors, byte[] v_spaces);
        void SendDisplay(string devName, int datatype, int icon_id, int g_code_id, int hor_space, string mesg, byte[] colors);
