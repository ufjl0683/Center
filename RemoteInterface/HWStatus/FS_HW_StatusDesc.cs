...
{
    public enum FS_HW_Status_Bit_Enum
    {
        DeviceErr = 0,
        CabineteOpen = 1,
        PortableTest = 2,
  ...
  public   class FS_HW_StatusDesc:I_HW_Status_Desc
    {
      ...
      byte[] m_status;
         public FS_HW_StatusDesc(string devName,byte[] hw_status, byte[] diff)
        {
        ...
        public FS_HW_StatusDesc(string devName,byte[] hw_status)
        ...
        {
            return ((FS_HW_Status_Bit_Enum)bitinx).ToString();
        }
        ...
        public System.Collections.IEnumerable getEnum(byte[] indexs)
        {
            ...
            {
                if (aryInx.Get(i))
                    yield return (FS_HW_Status_Bit_Enum)i;
            }
        }
