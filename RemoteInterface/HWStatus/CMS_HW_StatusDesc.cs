...
{
    public enum CMS_HW_Status_Bit_Enum
    {
        DeviceErr = 0,
        CabineteOpen = 1,
        PortableTest = 2,
  ...
  public   class CMS_HW_StatusDesc:I_HW_Status_Desc
    {
        ...
        byte[] diff;
         string devName;
      byte[] m_status;
         public CMS_HW_StatusDesc(string devName,byte[] hw_status, byte[] diff)
        {
        ...
        public CMS_HW_StatusDesc(string devName,byte[] hw_status)
        ...
        {
            return ((CMS_HW_Status_Bit_Enum)bitinx).ToString();
        }
        ...
        public System.Collections.IEnumerable getEnum(byte[] indexs)
        {
            ...
            {
                if (aryInx.Get(i))
                    yield return (CMS_HW_Status_Bit_Enum)i;
            }
        }
