  ...
  public  class Section
  {
     public  string lineid, sectionId, sectionName, direction;
      ...
      public override string ToString()
      {
          ...
          return this.sectionId + "," + this.sectionName;
      }
      ...
      //  int _speed = -1, _traveltime = -1;
        ...
        public int getSpeed()
        {
            System.DateTime dt = DateTime.Now;
               ...
               if (!hsTravelData.Contains(dt) || (hsTravelData[dt] as TravelData).Speed==0)
                   return -1;
        ...
        public int getTravelTime()
        {
            ...
            if (!hsTravelData.Contains(dt) || (hsTravelData[dt] as TravelData).TravelTime==0)
                return -1;
