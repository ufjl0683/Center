   ...
   public class JamRange :Range
    {
      ...
      // int BeginInx =int.MinValue, EndInx=int.MaxValue;
       ...
       public bool IsContain(JamRange r)
       {
           return StartIndex <= r.StartIndex && EndIndex >= r.EndIndex;
       }
       ...
       public JamRange[] Split()
       {
           ...
           for (int i = 1; i < devlist.Count - 1; i++)
           {
               ...
               if ((jamLevel == 2 && nextJamLevel == 2) || (jamLevel == -1 && nextJamLevel == 2) || (jamLevel == 2 && nextJamLevel == -1) || jamLevel < 2 && jamLevel >= 0) //2013-5-22
               {
