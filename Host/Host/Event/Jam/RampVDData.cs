   ...
   public  class RampVDData
    {
       ...
       public int metro_g_code_id;
       public string RGS_DeviceName;
       System.Timers.Timer tmr1min = new System.Timers.Timer(1000 * 60);

       public  int laneJamLevel=0;
        public RampVDData(string deviceName,string lineid,string dir,string divisionId,string divisionName,string InOut,TC.VDDeviceWrapper vd,int mile_m,int laneid,int metro_g_code_id,string RGS_DeviceName)
        {
            ...
            this.InOut = InOut;
            this.metro_g_code_id = metro_g_code_id;
            this.vd = vd;
            this.mile_m = mile_m;
            this.laneid = laneid;
            this.RGS_DeviceName = RGS_DeviceName;
