                    ...
                    while (rd.Read())
                    {
                        ...
                        catch (Exception ex)
                        {
                            ...
                            try
                            {
                                ...
                                dbServer.SendSqlCmd(string.Format("update tblVIData5Min set trycnt=trycnt+1 where devicename='{0}' and  timestamp='{1}'", devName, Comm.DB2.Db2.getTimeStampString(dt)));
