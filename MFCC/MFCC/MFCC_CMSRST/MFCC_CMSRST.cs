...
{
     public  class MFCC_CMSRST:MFCC_Base

     {
      

         public MFCC_CMSRST(string mfccid, string devType, int remotePort, int notifyPort, int consolePort, string regRemoteName, Type regRemoteType)
