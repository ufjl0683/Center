...
namespace Comm.TC
{
   ...
   //      private byte m_devType = 17;  //avi
         public AVITC(Protocol protocol, string devicename, string ip, int port, int deviceid, byte[] hw_status, byte opmode, byte opstatus,byte comm_state)
