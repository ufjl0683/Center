  ...
  public   class UnitRoad
    {
      ...
      public int getTravelTime()
      {
          ...
          {
              ConsoleServer.WriteLine(this.section + " His 取得時間模組錯誤!," + ex.Message);
              histime = -1;
          }
     ...
     public  int getAVI_TravelTime()
      ...
      public void getVDSpaceData(ref int vol, ref int traveltime)
      {
          try
          {
              int[] speeds = null; ;
      ...
      public int getVD_TravelTime()    //sec
      {
      ...
      public void  getAllVDTrafficData(ref string [] refVdList, ref  int volume, ref int speed,ref int occpuancy,ref int jamlevel /*,ref int traveltime*/)
      {
          int[] speeds = null;
          int [] occs=null;
          int[] jamlevels = null;
