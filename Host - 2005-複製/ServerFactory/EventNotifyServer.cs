...
namespace RemoteInterface
{
 public   class EventNotifyServer
         ...
         while (true)
         {
             try
             {
                 ...
                 //{
                     ...
                     ConsoleServer.WriteLine("Accept nocify client total cnt:"+clientStreamArray.Count);
                 //}
             }
             catch (Exception ex)
             {
    ...
    {
        System.Collections.ArrayList Register=System.Collections.ArrayList.Synchronized(new System.Collections.ArrayList());
