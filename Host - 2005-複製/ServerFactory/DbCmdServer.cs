...
namespace RemoteInterface
{
    public  class DbCmdServer
    {
      ...
      static   public string getDbConnectStr()
        {
            return Comm.DB2.Db2.db2ConnectionStr;
        }
                ...
                try
                {
                        ...
                        while( sqlQueue.Count > 0)
                        {
                            ...
                            catch (Exception ex1)
                            {
                              ...
                              //  Util.Log(Util.CPath(AppDomain.CurrentDomain.BaseDirectory + "dberr.log"), DateTime.Now + "," + ex1.Message + cmd.CommandText+"\r\n");
